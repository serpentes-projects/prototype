...
public class FileSystemIntegerTypeDefinitionAssertion extends IntegerTypeDefinitionAssertion implements FileSystemTypeDefinitionAssertion<Integer> {

    public FileSystemIntegerTypeDefinitionAssertion(final IntegerDefinitionContent integerDefinitionContent) {
        super(integerDefinitionContent);
    }
