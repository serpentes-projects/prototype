...
public class FileSystemMapWithAllValueTypesTypeDefinitionAssertion extends MapWithAllValueTypesTypeDefinitionAssertion implements FileSystemTypeDefinitionAssertion<ClassWithAllValueTypes> {

    public FileSystemMapWithAllValueTypesTypeDefinitionAssertion(final MapDefinitionContent mapDefinitionContent) {
    ...
    public DefinitionFileProperties getDefinitionFileProperties() {
        return new CustomDefinitionFileProperties("all.schema.json");
    }
}
