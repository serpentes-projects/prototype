...
public class NullCollectionInputAssertion implements CollectionInputAssertion<Object> {
    private final CollectionContent<Object> content;

    public NullCollectionInputAssertion(CollectionContent<Object> content) {
    ...
    @Override
    public void assertValue(final Collection<Object> value) {
    ...
    public DefaultCollectionInputVertex expectedRootInputVertex() {
        return DefaultInputVertexFactory.createCollectionVertex(
                content.allBeforeParsing().stream()
                        .map(value -> new DefaultInputTree(DefaultInputVertexFactory.createNullTerminalVertex()))
