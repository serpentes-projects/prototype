...
public class MapWithPrimitiveValueTypesJsonContent implements MapContent<ClassWithPrimitiveValueTypes> {
    static final Map<String, String> map;

    static {
        map = Map.of("null", "null", "boolean", "true", "integer", "1", "float", "1.1", "string", "string");
    }
