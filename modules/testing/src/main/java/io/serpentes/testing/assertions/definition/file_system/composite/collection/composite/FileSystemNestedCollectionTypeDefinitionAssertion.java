...
public class FileSystemNestedCollectionTypeDefinitionAssertion extends NestedCollectionTypeDefinitionAssertion implements FileSystemGenericBasedCollectionTypeDefinitionAssertion<Collection<?>> {

    public FileSystemNestedCollectionTypeDefinitionAssertion(CollectionDefinitionContent collectionDefinitionContent) {
    ...
    public DefinitionFileProperties getDefinitionFileProperties() {
        return new CustomDefinitionFileProperties("collection.schema.json");
    }
