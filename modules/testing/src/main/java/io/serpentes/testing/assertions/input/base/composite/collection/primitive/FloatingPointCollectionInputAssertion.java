...
public class FloatingPointCollectionInputAssertion implements CollectionInputAssertion<Double> {
    private final CollectionContent<Double> content;

    public FloatingPointCollectionInputAssertion(CollectionContent<Double> content) {
    ...
    @Override
    public Content<Collection<Double>> getContent() {
        return content;
    }

    @Override
    public Collection<Double> defaultExpectedValue() {
    ...
    @Override
    public void assertValue(final Collection<Double> value) {
    ...
    public DefaultCollectionInputVertex expectedRootInputVertex() {
        return DefaultInputVertexFactory.createCollectionVertex(
                content.allBeforeParsing().stream()
                        .map(value -> new DefaultInputTree(DefaultInputVertexFactory.createFloatingPointTerminalVertex(value)))
