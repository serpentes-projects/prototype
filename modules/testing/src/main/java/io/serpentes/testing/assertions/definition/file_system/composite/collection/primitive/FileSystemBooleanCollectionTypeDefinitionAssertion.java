...
public class FileSystemBooleanCollectionTypeDefinitionAssertion extends BooleanCollectionTypeDefinitionAssertion implements FileSystemGenericBasedCollectionTypeDefinitionAssertion<Boolean> {

    public FileSystemBooleanCollectionTypeDefinitionAssertion(CollectionDefinitionContent collectionDefinitionContent) {
    ...
    public DefinitionFileProperties getDefinitionFileProperties() {
        return new CustomDefinitionFileProperties("boolean.schema.json");
    }
}
