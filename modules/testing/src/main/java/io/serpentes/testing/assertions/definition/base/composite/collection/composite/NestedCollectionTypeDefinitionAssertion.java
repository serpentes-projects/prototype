...
public class NestedCollectionTypeDefinitionAssertion implements GenericBasedCollectionTypeDefinition<Collection<?>> {
    ...
    public NestedCollectionTypeDefinitionAssertion(CollectionDefinitionContent collectionDefinitionContent) {
