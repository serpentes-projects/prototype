...
public class FileSystemBooleanTypeDefinitionAssertion extends BooleanTypeDefinitionAssertion implements FileSystemTypeDefinitionAssertion<Boolean> {

    public FileSystemBooleanTypeDefinitionAssertion(final BooleanDefinitionContent booleanDefinitionContent) {
        super(booleanDefinitionContent);
    }
