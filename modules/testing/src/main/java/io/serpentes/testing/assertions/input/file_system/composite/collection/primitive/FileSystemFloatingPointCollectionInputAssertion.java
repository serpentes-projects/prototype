...
public class FileSystemFloatingPointCollectionInputAssertion extends FloatingPointCollectionInputAssertion implements FileSystemGenericBasedCollectionInputAssertion<Double> {

    public FileSystemFloatingPointCollectionInputAssertion(CollectionContent<Double> content) {
        super(content);
    }

    @Override
    public Path getInputPath() {
        return Paths.get("src", "test", "resources", "file_system", "json", "composite", "collection", "primitive", "float.json");
    }
