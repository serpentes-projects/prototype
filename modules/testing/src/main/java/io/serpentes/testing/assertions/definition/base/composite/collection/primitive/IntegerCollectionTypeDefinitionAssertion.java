...
public class IntegerCollectionTypeDefinitionAssertion implements GenericBasedCollectionTypeDefinition<Integer> {
    ...
    public IntegerCollectionTypeDefinitionAssertion(CollectionDefinitionContent collectionDefinitionContent) {
    ...
    public TypeTree expectedTypeTree() {
        return new DefaultTypeTree(
                DefaultTypeVertexFactory.createCollectionVertex(
                        DefaultTypeVertexFactory.createIntegerTerminalVertex()
                )
        );
    }
